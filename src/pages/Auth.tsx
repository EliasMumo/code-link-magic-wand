...
const Auth = () => {
  ...
  const [googleSignUpRole, setGoogleSignUpRole] = useState<'tenant' | 'landlord'>('tenant');
  ...
  const handleGoogleSignUp = async () => {
    try {
      localStorage.setItem('oauthRole', googleSignUpRole);
      setIsLoading(true);
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-600 bg-slate-50 p-2 rounded border border-slate-200">
                      New users: use the Sign Up tab to choose Tenant or Landlord when continuing with Google.
                    </p>
                  </div>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <Select value={googleSignUpRole} onValueChange={(value: 'tenant' | 'landlord') => setGoogleSignUpRole(value)}>
                        <SelectTrigger>
                    ...
                    >
                      ...
                      Continue with Google as {googleSignUpRole === 'tenant' ? 'Tenant' : 'Landlord'}
                    </Button>
                  </div>
                </form>
              </CardContent>
